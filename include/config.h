...
#define RADAR_MOTION_SENSITIVITY     40  // Movement detection threshold (0-100, lower = more sensitive)
#define RADAR_STATIONARY_SENSITIVITY 10  // Breathing/still presence threshold (lower = more sensitive)
